...
This script will identify missing mods, download them and launch DayZ with the mods. This script will also allow you to delete mods and save Favorite Servers. Just follow the instructions in the terminal window and that's it.
...
3: Run DZL by Opening the Application Menu Shortcut
or Terminal Command:
bash /home/$USER/DZL/DZL.sh



Video: How To Setup and Launch DZL: https://www.youtube.com/watch?v=bssSaxZ6hS4
